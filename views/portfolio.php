        ...
        <section id="home">
            <div class="hero-content">
                ...
                <div class="social-icons">
                    <?php
                    $socials = [
                        'contact_email' => ['icon' => 'mail', 'value' => get_setting('contact_email')],
                        'social_facebook' => ['icon' => 'facebook', 'value' => get_setting('social_facebook')],
                        'social_tiktok' => ['icon' => 'message-square', 'value' => get_setting('social_tiktok')],
                        'social_youtube' => ['icon' => 'youtube', 'value' => get_setting('social_youtube')],
                        'social_instagram' => ['icon' => 'instagram', 'value' => get_setting('social_instagram')],
                    ];

                    foreach ($socials as $key => $data) {
                        if (get_setting($key . '_enabled') && !empty($data['value'])) {
                            $url = ($key === 'contact_email') ? 'mailto:' . $data['value'] : $data['value'];
                            echo '<a href="' . e($url) . '" target="_blank"><i data-feather="' . e($data['icon']) . '"></i></a>';
                        }
                    }
                    ?>
                </div>
