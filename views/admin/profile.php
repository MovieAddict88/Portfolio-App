...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Whitelist of checkbox settings
    $checkbox_settings = [
        'contact_email_enabled', 'social_facebook_enabled', 'social_tiktok_enabled',
        'social_youtube_enabled', 'social_instagram_enabled'
    ];
...
<form action="admin.php?page=profile" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="checkbox" name="contact_email_enabled" value="1" <?php echo get_setting('contact_email_enabled') ? 'checked' : ''; ?>> Enable
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="checkbox" name="social_facebook_enabled" value="1" <?php echo get_setting('social_facebook_enabled') ? 'checked' : ''; ?>> Enable
    </div>
    <div class="form-group">
        ...
        <input type="checkbox" name="social_tiktok_enabled" value="1" <?php echo get_setting('social_tiktok_enabled') ? 'checked' : ''; ?>> Enable
    </div>
    <div class="form-group">
        ...
        <input type="checkbox" name="social_youtube_enabled" value="1" <?php echo get_setting('social_youtube_enabled') ? 'checked' : ''; ?>> Enable
    </div>
    <div class="form-group">
        ...
        <input type="checkbox" name="social_instagram_enabled" value="1" <?php echo get_setting('social_instagram_enabled') ? 'checked' : ''; ?>> Enable
    </div>
